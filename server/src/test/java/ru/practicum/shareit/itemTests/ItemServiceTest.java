...
class ItemServiceTest {
    ...
    void readAll() {
        ...
        List<ItemDto> items2 = itemService.readAll(0, 10);
    ...
    void readAllByUserId() {
        ...
        verify(itemRepository, times(1)).findAllByOwnerOrderByIdAsc(any(), any());
    ...
    void update() {
        ...
        Mockito
                .when(itemRepository.save(any()))
                .thenReturn(Optional.of(item).get());
        ItemDto item = itemService.update(1L, itemUpdate, user.getId());
    ...
    void validateName() {
        ...
        assertThrows(EntityNotFoundException.class, () -> itemService.create(itemFail, 1L));
    }
