...
class BookingRepositoryTest {
    ...
    void findByItemAndEndBeforeOrderByEndDesc() {
        Booking booking1 = bookingRepository.findFirstByItemIdAndStartBeforeAndStatusOrderByStartDesc(item.getId(),
                end, Status.APPROVED);
    ...
    void findByItemAndStartAfterOrderByStart() {
        Booking booking1 = bookingRepository.findFirstByItemAndStartAfterAndStatusOrderByStart(item, start,
                Status.APPROVED);
