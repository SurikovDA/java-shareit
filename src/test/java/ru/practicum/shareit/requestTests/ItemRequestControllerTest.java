...
class ItemRequestControllerTest {
    ...
    void getAllByRequestorId() throws Exception {
        ...
        List<ItemRequestWithAnswersDto> requests = List.of(RequestMapper.toItemRequestWithAnswersDto(request));
        Mockito
    ...
    void getById() throws Exception {
        request.setItems(List.of(item));
        ItemRequestWithAnswersDto request1 = RequestMapper.toItemRequestWithAnswersDto(request);
        Mockito
